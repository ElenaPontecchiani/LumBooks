...
<html lang="it">
   <head>
      <meta charset="UTF-8">
      <title>Libri venduti - LumBooks</title>
      <link rel="icon" href=""/><!-- link icona -->
      <meta name="title" content="Libri venduti - LumBooks" />
      <meta name="description" content="In questa pagina vedi i libri che hai venduto in passato" /><!-- da fare -->
      <meta name="keywords" content="libro, unipd" /><!-- da fare -->
      <meta name="language" content="italian it" />
      <meta name="author" content="" /><!-- da fare -->
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
      <link rel="stylesheet" type="text/css" href="../css/libri.css" /><!-- da fare -->
...
<div class="outerbox">
	...
	<dt class="item_spec">Acquirente</dt><dd class="spec_desc">NomeAcquirente</dd>
